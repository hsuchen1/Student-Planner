          ...
          {!isAdding && !editingTask && (
            <div className="flex items-center gap-2">
              ...
              <motion.button
                ...
                className="bg-primary-600 text-white hover:bg-primary-700 p-2.5 md:px-4 md:py-2 rounded-xl font-medium flex items-center gap-2 transition-colors shadow-sm"
              >
      ...
      <AnimatePresence mode="wait">
        {isAdding && (
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1.5 md:col-span-2">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 md:py-2 text-base bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all"
                />
              </div>
            ...
            <div className="flex justify-end gap-3 pt-2">
              ...
              <button
                type="submit"
                className="px-5 py-2.5 md:px-4 md:py-2 bg-slate-900 dark:bg-primary-600 text-white hover:bg-slate-800 dark:hover:bg-primary-700 rounded-xl font-medium transition-colors"
              >
                儲存任務
              </button>
            </div>
        ...
        {editingTask && (
          <motion.form
            ...
            className="bg-primary-50/50 dark:bg-primary-900/20 p-5 md:p-6 rounded-2xl shadow-sm border border-primary-100 dark:border-primary-500/30 space-y-4"
          >
            <div className="flex justify-between items-center mb-2">
              <h3 className="text-lg font-bold text-primary-900 dark:text-primary-100">編輯任務</h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1.5 md:col-span-2">
                <label className="text-sm font-medium text-primary-900/70 dark:text-primary-200/70">標題</label>
                <input
                  type="text"
                  required
                  value={editingTask.title}
                  onChange={e => setEditingTask({ ...editingTask, title: e.target.value })}
                  className="w-full px-4 py-3 md:py-2 text-base bg-white dark:bg-slate-900 border border-primary-200 dark:border-primary-500/30 text-slate-900 dark:text-white rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all"
                />
              </div>
              <div className="space-y-1.5">
                <label className="text-sm font-medium text-primary-900/70 dark:text-primary-200/70">類型</label>
                <select
              ...
              <div className="space-y-1.5">
                <label className="text-sm font-medium text-primary-900/70 dark:text-primary-200/70">截止日期與時間</label>
                <DatePicker
            ...
            <div className="flex justify-end gap-3 pt-2">
              <button
                ...
                className="px-5 py-2.5 md:px-4 md:py-2 text-primary-700 dark:text-primary-300 hover:bg-primary-100 dark:hover:bg-primary-900/50 rounded-xl font-medium transition-colors"
              >
                取消
              </button>
              <button
                type="submit"
                className="px-5 py-2.5 md:px-4 md:py-2 bg-primary-600 dark:bg-primary-500 text-white hover:bg-primary-700 dark:hover:bg-primary-600 rounded-xl font-medium transition-colors"
              >
                更新任務
              </button>
            </div>
    ...
    >
      ...
      >
        ...
        <button
          ...
          className="mt-0.5 flex-shrink-0 text-slate-400 dark:text-slate-500 hover:text-primary-600 dark:hover:text-primary-400 transition-colors focus:outline-none p-1 -ml-1"
        >
          {task.completed ? (
        ...
        <div className="flex items-center gap-1 md:opacity-0 group-hover:opacity-100 transition-opacity">
          <button
            onPointerDown={(e) => e.stopPropagation()}
            onClick={() => onEdit(task)}
            className="p-2 text-slate-400 dark:text-slate-500 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-primary-50 dark:hover:bg-primary-500/10 rounded-lg transition-colors focus:outline-none"
          >
